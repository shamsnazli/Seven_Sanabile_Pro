...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/dashboard/donation_request/approve_request/{id}', [DonationRequestController::class, 'approve_request']);
...
Route::get('/donateNow', [DonationRequestController::class, 'create']);
Route::post('/donateNow/store', [DonationRequestController::class, 'store']);
